...
namespace GreenPlanet
{
    public partial class registro : System.Web.UI.Page
    {
        ...
        public void reg_cliente(object sender, EventArgs e)
        {
            ...
            dal_usuario_web.Nombre_sp = "SP_Ingresar_Cliente";
            string msjError = "";

            dal_usuario_web.IdPersona = Request.Form["txt_user_cedula"];
            dal_usuario_web.NombreUsuario = Request.Form["txt_user_name"]; ;
            dal_usuario_web.Nombre = Request.Form["new_user_name"];
            dal_usuario_web.Apellidos = Request.Form["txt_p_ape"];
            dal_usuario_web.Correo = Request.Form["exampleInputEmail2"];
            dal_usuario_web.Tel = Request.Form["txt_telefono"];
            int distrito = Convert.ToByte(DropDownList3.SelectedValue.ToString());
            dal_usuario_web.IdDistrito = distrito;

            dal_usuario_web.NombreDireccion = Request.Form["exampleFormControlTextarea1"];
            int rol_us_web = 3;
            dal_usuario_web.IdRoles = rol_us_web;

            string cont = Request.Form["exampleInputPassword3"];
        ...
        public void changed(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                dal_usuario_web.DtParametros.Rows.Add("@idCanton", NormalizarParametro.almacenarTipo(ParametroSQL.TINYINT), DropDownList1.SelectedIndex.ToString());
        ...
        protected void ver_iniciar(object sender, EventArgs e)
        {
